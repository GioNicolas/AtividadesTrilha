...
# categoria_dict_vlr = defaultdict(float)
# categoria_dict_qtd = defaultdict(float)
# for venda in VENDAS:
#     id_produto = venda['id_produto']
#     categoria = produtos_dict[id_produto]['categoria']
#     categoria_dict_vlr[categoria] += float(venda['valor_total'])
#     categoria_dict_qtd[categoria] += float(venda['quantidade'])
# categoria_dict_vlr, categoria_dict_qtd
